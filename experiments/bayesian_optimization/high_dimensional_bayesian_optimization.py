"""
Implements the toy examples for Bayesian Optimization in high dimensions.
"""
...
from search_algorithms.bayesian_optimization import HighDimensionalBayesianOptimization
...
if __name__ == "__main__":
    ...
    objective_function = ObjectiveFunction(name, 0, n_dims=n_dims, model=model)
    limits = objective_function.limits
    solution_length = objective_function.solution_length

    bayes_opt = HighDimensionalBayesianOptimization(
